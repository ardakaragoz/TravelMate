...
public class HomeController {
    ...
    @FXML private VBox leaderboardContainer; // FXML'den burayı çektik

    @FXML
    public void initialize() {
        // LEADERBOARD'U KODLA DOLDURUYORUZ
    ...
    // --- LEADERBOARD SATIR EKLEME METODU ---
    ...
    // --- SENİN İSTEDİĞİN BLUR EFEKTLİ POPUP ---
    @FXML
    ...
    // Home butonu (Opsiyonel, zaten buradayız)
    @FXML
