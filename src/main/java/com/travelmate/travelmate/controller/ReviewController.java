...
public class ReviewController {
    ...
    @FXML
    private Label reviewsTitleLabel;

    private final ExecutorService networkExecutor = Executors.newCachedThreadPool();


    @FXML
    private HBox friendlinessStars;
    @FXML
    private HBox reliabilityStars;
    @FXML
    private HBox communicationStars;
    @FXML
    private HBox adaptationStars;
    @FXML
    private HBox budgetStars;
    @FXML
    private HBox helpfulnessStars;


    @FXML
    private Label friendlinessVal;
    @FXML
    private Label reliabilityVal;
    @FXML
    private Label communicationVal;
    @FXML
    private Label adaptationVal;
    @FXML
    private Label budgetVal;
    @FXML
    private Label helpfulnessVal;
    @FXML
    ...
    private void addReviewCard(String name, String subInfo, String date, String comment, double userScore, double[] details) {
        ...
        nameLbl.setTextFill(Color.web("#1E3A5F"));
        ...
        commentLbl.setStyle("-fx-font-size: 14px; -fx-text-fill: #333;");
        Label dateLbl = new Label("Travel Date: " + date);
        dateLbl.setStyle("-fx-font-weight: bold; -fx-text-fill: #555; -fx-font-size: 12px;");
        ...
        for (int i = 0; i < criteria.length; i++) {
            ...
            Label cLbl = new Label(criteria[i]);
            cLbl.setPrefWidth(100);
            cLbl.setStyle("-fx-font-size: 12px; -fx-font-weight: bold;");
